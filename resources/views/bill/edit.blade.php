      ...
      <div class="card-body p-0">
        ...
        <div class="row">
            ...
            <div class="p-5">
              ...
              <form class="user" method="POST" enctype="multipart/form-data" action="{{ route('bill.update',$bill->id) }}">
                ...
                <div class="form-group">
                    ...
                    <input value="{{$bill->subject}}" type="number "  step="any" min="1" class="form-control form-control-user @error('subject') is-invalid @enderror" name="subject" id="subject"  placeholder="Subjekti">
                ...
                <div class="form-group">
                    ...
                    <input value="{{$bill->bill_nr}}" type="number "  step="any" min="1" class="form-control form-control-user @error('bill-nr') is-invalid @enderror" name="bill-nr" id="bill-nr"  placeholder="Nr i faturës">
                ...
                <div class="form-group">
                    ...
                    <input value="{{$bill->value}}" type="number "  step="any" min="1" class="form-control form-control-user @error('Vlera') is-invalid @enderror" name="Vlera" id="value"  placeholder="Vlera">
                    @if ($errors->has('Vlera'))
          ...
          <div class="form-group "> 
            ...
            <input value="{{$bill->deadline}}"  type="date" class="form-control form-control-user @error('Vlera') is-invalid @enderror" required="" name="Afati" id="deadline" min="{{date('Y-m-d')}}" placeholder="Afati">
            @if ($errors->has('Afati'))
