        ...
        <div class="p-5">
          ...
          <form class="user" method="POST" action="{{ route('treatment.update',$treatment->id) }}">
            ...
            <div class="form-group ">
              ...
              <input  placeholder="Vizita" value="{{App\Visit::getVisitPacientName($treatment->visit_id)}}" class="form-control form-control-user" id="visit" name="visit"  data-toggle="modal" data-target="#visitModal" />
            <input  hidden id="visit-id"  name="visit-id" value="{{$treatment->visit_id}}"/>
            ...
            <div class="form-group ">
                ...
                <input id="type_of_treatment" name="type_of_treatment" value="{{$treatment->type_of_treatment }}" required autofocus type="text" class="form-control form-control-user"  placeholder="Tipi i trajtimit">
            ...
            <input type="text" required class="form-control form-control-user" required="" value="{{$treatment->duration}}" name="duration" id="duration"  placeholder="Kohezgjatja">
