...
@section('content')
  ...
  <div class="container-fluid mt-4">
    ...
    <div class="row">
      <div class="col-sm-6">
        <h1 class="h3 mb-4 @if(App\User::getAppTheme() == true) text-gray-100 @else text-gray-800 @endif">Trajtimet</h1>
      </div>
      <div class="col-sm-6 ">
          <a href="/treatment/create" class="btn btn-circle btn-success float-right"><i class="fa fa-plus"></i></a>
        </div>
    </div>
