      ...
      <div class="col-lg-7">
        <div class="p-5">
          <div class="text-center">
            <h1 class="h4 @if(App\User::getAppTheme() == true) text-gray-100 @else text-gray-900 @endif mb-4">Ndrysho Vizitën!</h1>
          </div>
          <form class="user" method="POST" action="{{ route('visit.update',$visit->id) }}">
                 {{ method_field('PUT') }}
                    ...
                    <div class="form-group ">
                        ...
                        <input readonly value="{{App\Pacient::getPacient($visit->pacient_id)}}" placeholder="Pacienti" class="form-control form-control-user @error('pacient-id') is-invalid @enderror" id="pacient" name="pacient"  data-toggle="modal" data-target="#pacientModal"/>
                    ...
                    <div class="form-group ">
                            ...
                            <input readonly  value="{{App\User::getUser($visit->user_id)}}" placeholder="Dentisti" class="form-control form-control-user  @error('user-id') is-invalid @enderror  " id="user" name="user" data-toggle="modal" data-target="#userModal"  />
            ...
            <div class="form-group ">
                    ...
                    <input type="date" value="{{$visit->visit_date}}" class="form-control form-control-user @error('data') is-invalid @enderror" required="" name="data" id="data" max="{{date('Y-m-d')}}" placeholder="Data e Vizitës">
                    @if ($errors->has('data'))
                    <span class="help-block">
